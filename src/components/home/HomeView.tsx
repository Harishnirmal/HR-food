    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-8">
          <div>
            <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#8F4A2D]">
          ...
          <button
            ...
            className="text-xs font-bold text-[#183928] hover:text-[#C85A32] flex items-center gap-1 group"
          >
          ...
          {activeCategories.map((cat) => {
            ...
            return (
              <div
                ...
                className="group bg-white rounded-2xl border border-[#ECE3D5] p-3 hover:border-[#C85A32] hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col items-center text-center select-none"
              >
                ...
                <h3 className="font-serif font-bold text-xs sm:text-sm text-stone-900 group-hover:text-[#C85A32] transition-colors leading-tight line-clamp-1">
                  {cat.name}
                </h3>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-8">
          <div>
            <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#C85A32]">
              <Flame className="w-3.5 h-3.5 fill-[#C85A32]" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-[#183928] to-[#0F241A] rounded-3xl p-6 sm:p-10 text-white shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-7 space-y-4">
              <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-[#E6C687] text-[#183928]">
              ...
              <p className="text-sm sm:text-base text-[#C5D6CC] leading-relaxed">
              ...
              <div className="pt-2 flex flex-wrap gap-3">
                <button
                  ...
                  className="px-6 py-3 rounded-xl bg-[#E6C687] text-[#183928] hover:bg-[#F3DFA2] font-bold text-xs shadow-md transition-all active:scale-95 flex items-center gap-2"
                >
      ...
      {chefSpecials.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-8">
            <div>
              <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#183928]">
                <ChefHat className="w-3.5 h-3.5 text-[#183928]" />
      ...
      {/* 6. Why Families Love Annapoorna (Pillars of Quality) */}
      <section className="bg-[#F4ECE1] py-16 border-y border-[#E8DFC8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-[#E8DFD3] shadow-xs text-center space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-[#183928] text-[#E6C687] flex items-center justify-center mx-auto text-xl font-bold">
                🧈
              </div>
              <h3 className="font-serif font-bold text-base text-stone-900">100% Pure Cow Ghee</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E8DFD3] shadow-xs text-center space-y-3">
              ...
              <h3 className="font-serif font-bold text-base text-stone-900">Fresh Ground Chutneys</h3>
              <p className="text-xs text-stone-500 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E8DFD3] shadow-xs text-center space-y-3">
              ...
              <h3 className="font-serif font-bold text-base text-stone-900">Insulated Hot Delivery</h3>
              <p className="text-xs text-stone-500 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E8DFD3] shadow-xs text-center space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-[#183928] text-[#25D366] flex items-center justify-center mx-auto text-xl font-bold">
                <MessageCircle className="w-6 h-6 fill-current" />
              </div>
              <h3 className="font-serif font-bold text-base text-stone-900">WhatsApp Speed Ordering</h3>
              <p className="text-xs text-stone-500 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-3 relative">
            <div className="w-9 h-9 rounded-xl bg-[#183928] text-white flex items-center justify-center font-bold text-sm">
              1
            </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-3 relative">
            <div className="w-9 h-9 rounded-xl bg-[#25D366] text-stone-900 flex items-center justify-center font-bold text-sm">
              2
            </div>
            <h3 className="font-serif font-bold text-base text-stone-900">
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-3 relative">
            <div className="w-9 h-9 rounded-xl bg-[#C85A32] text-white flex items-center justify-center font-bold text-sm">
              3
            </div>
            <h3 className="font-serif font-bold text-base text-stone-900">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-4 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 pt-3 border-t border-stone-100">
              <div className="w-10 h-10 rounded-full bg-[#F4ECE1] text-[#8F4A2D] font-bold flex items-center justify-center text-sm">
                MK
              </div>
              <div>
                <p className="text-xs font-bold text-stone-900">Meenakshi Krishnan</p>
                <p className="text-[10px] text-stone-400">Adyar, Chennai</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-4 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 pt-3 border-t border-stone-100">
              ...
              <div>
                <p className="text-xs font-bold text-stone-900">Arun Ramachandran</p>
                <p className="text-[10px] text-stone-400">Besant Nagar, Chennai</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#E8DFD3] shadow-xs space-y-4 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 pt-3 border-t border-stone-100">
              ...
              <div>
                <p className="text-xs font-bold text-stone-900">Priya Venkat</p>
                <p className="text-[10px] text-stone-400">Thiruvanmiyur, Chennai</p>
              </div>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-serif font-bold text-stone-900 text-sm sm:text-base hover:text-[#C85A32] transition-colors"
                >
                  <span>{faq.q}</span>
                  {isOpen ? (
                    <ChevronUp className="w-4 h-4 text-[#C85A32] shrink-0" />
                  ) : (
                ...
                {isOpen && (
                  <div className="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-stone-600 leading-relaxed border-t border-stone-100 pt-3 animate-in fade-in duration-150">
                    {faq.a}
                  </div>
                )}
              </div>
